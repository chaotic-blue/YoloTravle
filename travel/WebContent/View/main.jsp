...
<%
	...
	if(contentPage==null)
	    contentPage="../airport/airportList.jsp";	
%>
<!DOCTYPE html>
<html>
<head>
...
<video id="videobcg" preload="auto" autoplay="true" loop="loop" muted="muted" volume="0">
     <source src="<%=request.getContextPath()%>/etc/lax-big.mp4" type="video/mp4">
     <source src="<%=request.getContextPath()%>/etc/movie.webm" type="video/webm">
        
</video>

	<%-- <jsp:include page="../View/rank.jsp"/> --%>
	<div style="height:5%;">
	<jsp:include page="../partition/header.jsp" />
	</div>
	<div class="sidebar" style="width:13%; height:100%;">
	<jsp:include page="../partition/sidebar.jsp" />
	</div>
	<!--  메인화면 부분 -->
