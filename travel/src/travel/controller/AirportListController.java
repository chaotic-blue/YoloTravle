...
public class AirportListController extends HttpServlet {
	...
	protected void actionDo(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (com.equals("/AirportList.al")) {
			...
			viewPage = "AirportMain.al?contentPage=/airport/airportList.jsp";
			...
			alc.execute(request, response);
			viewPage = "/airport/airportList.jsp";
		// 관리자 : 회원들의 예약정보 관리
			...
			viewPage = "/View/ReservationManage.jsp";
		}
		// 회원 : 자기자신의 예약정보 관리
		...
		//공항날씨
			...
			viewPage = "AirportMain.al?contentPage=/airport/airportWeather.jsp";
		}
		//근처의 공항위치
		else if (com.equals("/AirportNear.al")) {
			viewPage = "AirportMain.al?contentPage=/airport/airportNear.jsp";
		}
		//항공사 등급
		else if (com.equals("/AirportRank.al")) {
			viewPage = "AirportMain.al?contentPage=/airport/airportRank.jsp";
		}
		
		//실시간급상승
		else if (com.equals("/rankInfo.al")) {
			viewPage = "AirportMain.al?contentPage=/View/rankInfo.jsp";
